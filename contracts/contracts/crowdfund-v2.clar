...
;; 1. Create a Campaign (Project Registration on Stacks)
(define-public (create-campaign (title (string-ascii 64)) (description (string-utf8 256)) (target-stx uint) (duration-blocks uint))
    (let
        (
